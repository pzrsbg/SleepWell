...
var appendInputs = function (orderItemNumber) {
    ...
    for (var i = 0; i < servicesCount; i++) {
        ...
        servicesInputs.append('<input type="hidden" name="Order.OrderItems[' + orderItemNumber + '].OrderItemDetails[' + i + '].ServiceId" value="' + serviceId + '">');
        servicesInputs.append('<input type="hidden" name="Order.OrderItems[' + orderItemNumber + '].OrderItemDetails[' + i + '].UnitPrice" value="' + unitPrice + '">');
    }
